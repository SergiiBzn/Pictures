...
/* harmony default export */ __webpack_exports__["default"] = (drop); // drag *
// dragend *
// dragenter - обьект над dropArea
// dragexit *
// dragleave - обьект за пределами dropArea
// dragover - обьект перетаскивают над dropArea
// dragstart *
// drop - обьект упал в dropArea
// * - срабатівают на єлементе которsй мs перетаскуем
